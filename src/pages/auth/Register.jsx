                    ...
                    <form className="space-y-4">
                        ...
                        <div className="flex items-center">
                            ...
                            <span className="ml-2 text-sm text-gray-600">
                                Tôi đồng ý với{' '}
                                <a href="#" className="text-green-600 hover:text-green-700 cursor-pointer">Điều khoản sử dụng</a>
                                {' '}và{' '}
                                <a href="#" className="text-green-600 hover:text-green-700 cursor-pointer">Chính sách bảo mật</a>
                            </span>
                        </div>
                        <button
                            type="submit"
